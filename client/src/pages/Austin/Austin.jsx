      ...
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="mb-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            {hasAustinProperties || hasFeaturedProperties ? "Properties in Austin" : "All Properties"}
          </h1>
        ...
        {hasFeaturedProperties && (
          <DisplayRow
            properties={data}
            filter={createFilter.featured('Austin', featuredPropertyIds)}
        ...
        {hasAustinProperties && (
          <DisplayGrid
            properties={filteredAustinProperties}
            filter={{ type: 'all' }}
            title={hasFeaturedProperties ? "Other Properties In Austin" : "All Properties in Austin"}
          />
        )}
        ...
        {!hasAustinProperties && areaQuery && (
          <div className="text-center py-8">
            <p className="text-lg text-gray-600 mb-4">
              No Austin properties match "{areaQuery}".
            </p>
            {showFallback && (
          ...
          <div className="text-center py-12">
            <p className="text-lg text-gray-600 mb-4">
              {areaQuery 
                ...
                : "Sorry! We sold through everything in Austin!"
              }
            </p>
          </div>
        )}
